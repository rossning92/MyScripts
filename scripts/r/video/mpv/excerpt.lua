...
function excerpt_write_handler()
	...
	local p = {}
	p["cancellable"] = false
	p["args"] = {"ffmpeg", "-y", "-nostdin", "-ss", tostring(excerpt_begin), "-i", tostring(srcname), "-t", tostring(duration), "-codec:v", "copy", "-codec:a", "copy", "-codec:d", "copy", tostring(dstname)}
...
mp.add_forced_key_binding("i", "excerpt_mark_begin", excerpt_mark_begin_handler)
mp.add_forced_key_binding("shift+i", "excerpt_seek_begin", excerpt_seek_begin_handler)
mp.add_forced_key_binding("o", "excerpt_mark_end", excerpt_mark_end_handler)
mp.add_forced_key_binding("shift+o", "excerpt_seek_end", excerpt_seek_end_handler)
mp.add_forced_key_binding("x", "excerpt_write", excerpt_write_handler)

mp.add_forced_key_binding("shift+right", "excerpt_keyframe_forward", excerpt_keyframe_forward, { repeatable = true; complex = true })
mp.add_forced_key_binding("shift+left", "excerpt_keyframe_back", excerpt_keyframe_back, { repeatable = true; complex = true })
mp.add_forced_key_binding("right", "excerpt_frame_forward", excerpt_frame_forward, { repeatable = true; complex = true })
mp.add_forced_key_binding("left", "excerpt_frame_back", excerpt_frame_back, { repeatable = true; complex = true })

mp.add_forced_key_binding("e", "excerpt_zoom_in", excerpt_zoom_in, { repeatable = true; complex = false })
mp.add_forced_key_binding("w", "excerpt_zoom_out", excerpt_zoom_out, { repeatable = true; complex = false })

mp.add_forced_key_binding("ctrl+right", "excerpt_pan_right", excerpt_pan_right, { repeatable = true; complex = false })
mp.add_forced_key_binding("ctrl+left", "excerpt_pan_leftt", excerpt_pan_left, { repeatable = true; complex = false })
mp.add_forced_key_binding("ctrl+up", "excerpt_pan_up", excerpt_pan_up, { repeatable = true; complex = false })
mp.add_forced_key_binding("ctrl+down", "excerpt_pan_down", excerpt_pan_down, { repeatable = true; complex = false })
